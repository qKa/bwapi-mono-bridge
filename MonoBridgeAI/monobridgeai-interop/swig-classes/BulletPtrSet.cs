...
public partial class BulletPtrSet : IDisposable 
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bridgePINVOKE.delete_BulletPtrSet(swigCPtr);
        }
 ...
 public System.Collections.Generic.ICollection<Bullet> Values {
  ...
  public BulletPtrSet() : this(bridgePINVOKE.new_BulletPtrSet__SWIG_0(), true) {
  }

  public BulletPtrSet(BulletPtrSet other) : this(bridgePINVOKE.new_BulletPtrSet__SWIG_1(BulletPtrSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.BulletPtrSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.BulletPtrSet_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    bridgePINVOKE.BulletPtrSet_Clear(swigCPtr);
  }

  public Bullet getitem(Bullet key) {
    IntPtr cPtr = bridgePINVOKE.BulletPtrSet_getitem(swigCPtr, Bullet.getCPtr(key));
  ...
  public bool ContainsKey(Bullet key) {
    bool ret = bridgePINVOKE.BulletPtrSet_ContainsKey(swigCPtr, Bullet.getCPtr(key));
    return ret;
  }

  public void Add(Bullet key) {
    bridgePINVOKE.BulletPtrSet_Add(swigCPtr, Bullet.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(Bullet key) {
    bool ret = bridgePINVOKE.BulletPtrSet_Remove(swigCPtr, Bullet.getCPtr(key));
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.BulletPtrSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Bullet get_next_key(IntPtr swigiterator) {
    IntPtr cPtr = bridgePINVOKE.BulletPtrSet_get_next_key(swigCPtr, swigiterator);
    Bullet ret = (cPtr == IntPtr.Zero) ? null : new Bullet(cPtr, false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
