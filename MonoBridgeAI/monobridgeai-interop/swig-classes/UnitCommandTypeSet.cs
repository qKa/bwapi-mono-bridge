...
public partial class UnitCommandTypeSet : IDisposable 
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bridgePINVOKE.delete_UnitCommandTypeSet(swigCPtr);
        }
 ...
 public System.Collections.Generic.ICollection<UnitCommandType> Values {
  ...
  public UnitCommandTypeSet() : this(bridgePINVOKE.new_UnitCommandTypeSet__SWIG_0(), true) {
  }

  public UnitCommandTypeSet(UnitCommandTypeSet other) : this(bridgePINVOKE.new_UnitCommandTypeSet__SWIG_1(UnitCommandTypeSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.UnitCommandTypeSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.UnitCommandTypeSet_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    bridgePINVOKE.UnitCommandTypeSet_Clear(swigCPtr);
  }

  public UnitCommandType getitem(UnitCommandType key) {
    UnitCommandType ret = new UnitCommandType(bridgePINVOKE.UnitCommandTypeSet_getitem(swigCPtr, UnitCommandType.getCPtr(key)), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(UnitCommandType key) {
    bool ret = bridgePINVOKE.UnitCommandTypeSet_ContainsKey(swigCPtr, UnitCommandType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(UnitCommandType key) {
    bridgePINVOKE.UnitCommandTypeSet_Add(swigCPtr, UnitCommandType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(UnitCommandType key) {
    bool ret = bridgePINVOKE.UnitCommandTypeSet_Remove(swigCPtr, UnitCommandType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.UnitCommandTypeSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public UnitCommandType get_next_key(IntPtr swigiterator) {
    UnitCommandType ret = new UnitCommandType(bridgePINVOKE.UnitCommandTypeSet_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
