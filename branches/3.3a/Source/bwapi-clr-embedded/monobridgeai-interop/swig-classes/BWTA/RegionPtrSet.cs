...
public partial class RegionPtrSet : IDisposable 
 ...
 public System.Collections.Generic.ICollection<Region> Values {
  ...
  public Region getitem(Region key) {
    IntPtr cPtr = bwtaPINVOKE.RegionPtrSet_getitem(swigCPtr, Region.getCPtr(key));
  ...
  public IntPtr create_iterator_begin() {
    IntPtr ret = bwtaPINVOKE.RegionPtrSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Region get_next_key(IntPtr swigiterator) {
    IntPtr cPtr = bwtaPINVOKE.RegionPtrSet_get_next_key(swigCPtr, swigiterator);
    Region ret = (cPtr == IntPtr.Zero) ? null : new Region(cPtr, false);
    if (bwtaPINVOKE.SWIGPendingException.Pending) throw bwtaPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
