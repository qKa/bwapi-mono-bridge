...
public partial class UnitTypeSet : IDisposable 
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bwapiPINVOKE.delete_UnitTypeSet(swigCPtr);
        }
 ...
 public System.Collections.Generic.ICollection<UnitType> Values {
  ...
  public UnitTypeSet() : this(bwapiPINVOKE.new_UnitTypeSet__SWIG_0(), true) {
  }
  ...
  private uint size() {
    uint ret = bwapiPINVOKE.UnitTypeSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bwapiPINVOKE.UnitTypeSet_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    bwapiPINVOKE.UnitTypeSet_Clear(swigCPtr);
  }

  public UnitType getitem(UnitType key) {
    UnitType ret = new UnitType(bwapiPINVOKE.UnitTypeSet_getitem(swigCPtr, UnitType.getCPtr(key)), false);
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(UnitType key) {
    bool ret = bwapiPINVOKE.UnitTypeSet_ContainsKey(swigCPtr, UnitType.getCPtr(key));
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(UnitType key) {
    bwapiPINVOKE.UnitTypeSet_Add(swigCPtr, UnitType.getCPtr(key));
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(UnitType key) {
    bool ret = bwapiPINVOKE.UnitTypeSet_Remove(swigCPtr, UnitType.getCPtr(key));
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bwapiPINVOKE.UnitTypeSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public UnitType get_next_key(IntPtr swigiterator) {
    UnitType ret = new UnitType(bwapiPINVOKE.UnitTypeSet_get_next_key(swigCPtr, swigiterator), false);
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
