  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bwapiPINVOKE.delete_Player(swigCPtr);
        }
...
public static bool operator !=(Player obj1, Player obj2)
{
  ...
  public virtual Force getForce() {
    IntPtr cPtr = bwapiPINVOKE.Player_getForce(swigCPtr);
  ...
  public virtual int cumulativeMinerals() {
    int ret = bwapiPINVOKE.Player_cumulativeMinerals(swigCPtr);
    return ret;
  }

  public virtual int cumulativeGas() {
    int ret = bwapiPINVOKE.Player_cumulativeGas(swigCPtr);
    return ret;
  }
