...
public partial class PlayerPtrSet : IDisposable 
#if !SWIG_DOTNET_1
 ...
 public System.Collections.Generic.ICollection<Player> Values {
  ...
  public Player getitem(Player key) {
    IntPtr cPtr = bwapiPINVOKE.PlayerPtrSet_getitem(swigCPtr, Player.getCPtr(key));
  ...
  public IntPtr create_iterator_begin() {
    IntPtr ret = bwapiPINVOKE.PlayerPtrSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Player get_next_key(IntPtr swigiterator) {
    IntPtr cPtr = bwapiPINVOKE.PlayerPtrSet_get_next_key(swigCPtr, swigiterator);
    Player ret = (cPtr == IntPtr.Zero) ? null : new Player(cPtr, false);
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
