...
public partial class WeaponTypeSet : IDisposable 
 ...
 public System.Collections.Generic.ICollection<WeaponType> Values {
  ...
  public WeaponTypeSet() : this(bridgePINVOKE.new_WeaponTypeSet__SWIG_0(), true) {
  }

  public WeaponTypeSet(WeaponTypeSet other) : this(bridgePINVOKE.new_WeaponTypeSet__SWIG_1(WeaponTypeSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.WeaponTypeSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.WeaponTypeSet_empty(swigCPtr);
    return ret;
  }
  ...
  public WeaponType getitem(WeaponType key) {
    WeaponType ret = new WeaponType(bridgePINVOKE.WeaponTypeSet_getitem(swigCPtr, WeaponType.getCPtr(key)), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(WeaponType key) {
    bool ret = bridgePINVOKE.WeaponTypeSet_ContainsKey(swigCPtr, WeaponType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(WeaponType key) {
    bridgePINVOKE.WeaponTypeSet_Add(swigCPtr, WeaponType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(WeaponType key) {
    bool ret = bridgePINVOKE.WeaponTypeSet_Remove(swigCPtr, WeaponType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.WeaponTypeSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public WeaponType get_next_key(IntPtr swigiterator) {
    WeaponType ret = new WeaponType(bridgePINVOKE.WeaponTypeSet_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
