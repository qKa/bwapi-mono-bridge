...
public class TechTypeSet : IDisposable 
 ...
 public System.Collections.Generic.ICollection<TechType> Values {
  ...
  public TechTypeSet() : this(bridgePINVOKE.new_TechTypeSet__SWIG_0(), true) {
  }

  public TechTypeSet(TechTypeSet other) : this(bridgePINVOKE.new_TechTypeSet__SWIG_1(TechTypeSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.TechTypeSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.TechTypeSet_empty(swigCPtr);
    return ret;
  }
  ...
  public TechType getitem(TechType key) {
    TechType ret = new TechType(bridgePINVOKE.TechTypeSet_getitem(swigCPtr, TechType.getCPtr(key)), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(TechType key) {
    bool ret = bridgePINVOKE.TechTypeSet_ContainsKey(swigCPtr, TechType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(TechType key) {
    bridgePINVOKE.TechTypeSet_Add(swigCPtr, TechType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(TechType key) {
    bool ret = bridgePINVOKE.TechTypeSet_Remove(swigCPtr, TechType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.TechTypeSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public TechType get_next_key(IntPtr swigiterator) {
    TechType ret = new TechType(bridgePINVOKE.TechTypeSet_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
