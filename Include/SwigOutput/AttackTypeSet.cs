...
public class AttackTypeSet : IDisposable 
#if !SWIG_DOTNET_1
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bridgePINVOKE.delete_AttackTypeSet(swigCPtr);
        }
 ...
 public System.Collections.Generic.ICollection<AttackType> Values {
  ...
  public AttackTypeSet() : this(bridgePINVOKE.new_AttackTypeSet__SWIG_0(), true) {
  }

  public AttackTypeSet(AttackTypeSet other) : this(bridgePINVOKE.new_AttackTypeSet__SWIG_1(AttackTypeSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.AttackTypeSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.AttackTypeSet_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    bridgePINVOKE.AttackTypeSet_Clear(swigCPtr);
  }

  public AttackType getitem(AttackType key) {
    AttackType ret = new AttackType(bridgePINVOKE.AttackTypeSet_getitem(swigCPtr, AttackType.getCPtr(key)), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(AttackType key) {
    bool ret = bridgePINVOKE.AttackTypeSet_ContainsKey(swigCPtr, AttackType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(AttackType key) {
    bridgePINVOKE.AttackTypeSet_Add(swigCPtr, AttackType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(AttackType key) {
    bool ret = bridgePINVOKE.AttackTypeSet_Remove(swigCPtr, AttackType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.AttackTypeSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public AttackType get_next_key(IntPtr swigiterator) {
    AttackType ret = new AttackType(bridgePINVOKE.AttackTypeSet_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
