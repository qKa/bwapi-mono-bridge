...
public class PlayerTypeSet : IDisposable 
 ...
 public System.Collections.Generic.ICollection<PlayerType> Values {
  ...
  public PlayerTypeSet() : this(bridgePINVOKE.new_PlayerTypeSet__SWIG_0(), true) {
  }

  public PlayerTypeSet(PlayerTypeSet other) : this(bridgePINVOKE.new_PlayerTypeSet__SWIG_1(PlayerTypeSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.PlayerTypeSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.PlayerTypeSet_empty(swigCPtr);
    return ret;
  }
  ...
  public PlayerType getitem(PlayerType key) {
    PlayerType ret = new PlayerType(bridgePINVOKE.PlayerTypeSet_getitem(swigCPtr, PlayerType.getCPtr(key)), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(PlayerType key) {
    bool ret = bridgePINVOKE.PlayerTypeSet_ContainsKey(swigCPtr, PlayerType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(PlayerType key) {
    bridgePINVOKE.PlayerTypeSet_Add(swigCPtr, PlayerType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(PlayerType key) {
    bool ret = bridgePINVOKE.PlayerTypeSet_Remove(swigCPtr, PlayerType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.PlayerTypeSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public PlayerType get_next_key(IntPtr swigiterator) {
    PlayerType ret = new PlayerType(bridgePINVOKE.PlayerTypeSet_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
