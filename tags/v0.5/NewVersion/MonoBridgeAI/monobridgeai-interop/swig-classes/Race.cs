...
public static bool operator !=(Race obj1, Race obj2)
{
  ...
  public UnitType getWorker() {
    UnitType ret = new UnitType(bridgePINVOKE.Race_getWorker(swigCPtr), true);
    return ret;
  }

  public UnitType getCenter() {
    UnitType ret = new UnitType(bridgePINVOKE.Race_getCenter(swigCPtr), true);
    return ret;
  }

  public UnitType getRefinery() {
    UnitType ret = new UnitType(bridgePINVOKE.Race_getRefinery(swigCPtr), true);
    return ret;
  }

  public UnitType getTransport() {
    UnitType ret = new UnitType(bridgePINVOKE.Race_getTransport(swigCPtr), true);
    return ret;
  }

  public UnitType getSupplyProvider() {
    UnitType ret = new UnitType(bridgePINVOKE.Race_getSupplyProvider(swigCPtr), true);
    return ret;
  }
