...
public static bool operator !=(Bullet obj1, Bullet obj2)
{
  ...
  public virtual SWIGTYPE_p_BulletType getType() {
    SWIGTYPE_p_BulletType ret = new SWIGTYPE_p_BulletType(bridgePINVOKE.Bullet_getType(swigCPtr), true);
    return ret;
  }
  ...
  public virtual SWIGTYPE_p_Position getPosition() {
    SWIGTYPE_p_Position ret = new SWIGTYPE_p_Position(bridgePINVOKE.Bullet_getPosition(swigCPtr), true);
    return ret;
  }
  ...
  public virtual SWIGTYPE_p_Position getTargetPosition() {
    SWIGTYPE_p_Position ret = new SWIGTYPE_p_Position(bridgePINVOKE.Bullet_getTargetPosition(swigCPtr), true);
    return ret;
  }
