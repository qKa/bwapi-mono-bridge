...
public static bool operator !=(Polygon obj1, Polygon obj2)
{
  ...
  public SWIGTYPE_p_std__vectorT_BWTA__Polygon_t getHoles() {
    SWIGTYPE_p_std__vectorT_BWTA__Polygon_t ret = new SWIGTYPE_p_std__vectorT_BWTA__Polygon_t(bridgePINVOKE.Polygon_getHoles(swigCPtr), false);
    return ret;
  }

  public SWIGTYPE_p_std__vectorT_BWTA__Polygon_t holes {
    set {
      bridgePINVOKE.Polygon_holes_set(swigCPtr, SWIGTYPE_p_std__vectorT_BWTA__Polygon_t.getCPtr(value));
    } 
    get {
      IntPtr cPtr = bridgePINVOKE.Polygon_holes_get(swigCPtr);
      SWIGTYPE_p_std__vectorT_BWTA__Polygon_t ret = (cPtr == IntPtr.Zero) ? null : new SWIGTYPE_p_std__vectorT_BWTA__Polygon_t(cPtr, false);
      return ret;
    } 
  }
