...
public static bool operator !=(UnitType obj1, UnitType obj2)
{
  ...
  public UnitTypeIntPair whatBuilds() {
    UnitTypeIntPair ret = new UnitTypeIntPair(bridgePINVOKE.UnitType_whatBuilds(swigCPtr), true);
    return ret;
  }

  public UnitTypeIntMap requiredUnits() {
    UnitTypeIntMap ret = new UnitTypeIntMap(bridgePINVOKE.UnitType_requiredUnits(swigCPtr), false);
    return ret;
  }
