...
public partial class EventList : IDisposable, System.Collections.IEnumerable
...
#endif
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bridgePINVOKE.delete_EventList(swigCPtr);
        }
  ...
  public void Clear() {
    bridgePINVOKE.EventList_Clear(swigCPtr);
  }

  public void Add(Event x) {
    bridgePINVOKE.EventList_Add(swigCPtr, Event.getCPtr(x));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.EventList_size(swigCPtr);
    return ret;
  }

  public EventList() : this(bridgePINVOKE.new_EventList__SWIG_0(), true) {
  }

  public EventList(EventList other) : this(bridgePINVOKE.new_EventList__SWIG_1(EventList.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.EventList_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Event get_next_key(IntPtr swigiterator) {
    Event ret = new Event(bridgePINVOKE.EventList_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
