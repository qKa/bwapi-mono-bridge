  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bwapiPINVOKE.delete_Order(swigCPtr);
        }
...
public static bool operator !=(Order obj1, Order obj2)
{
  ...
  public Order() : this(bwapiPINVOKE.new_Order__SWIG_0(), true) {
  }

  public Order(int id) : this(bwapiPINVOKE.new_Order__SWIG_1(id), true) {
  }
  ...
  public int getID() {
    int ret = bwapiPINVOKE.Order_getID(swigCPtr);
    return ret;
  }

  public string getName() {
    string ret = bwapiPINVOKE.Order_getName(swigCPtr);
    return ret;
  }
