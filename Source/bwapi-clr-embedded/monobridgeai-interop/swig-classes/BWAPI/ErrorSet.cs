...
public partial class ErrorSet : IDisposable 
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bwapiPINVOKE.delete_ErrorSet(swigCPtr);
        }
 ...
 public System.Collections.Generic.ICollection<Error> Values {
  ...
  public ErrorSet() : this(bwapiPINVOKE.new_ErrorSet__SWIG_0(), true) {
  }
  ...
  private uint size() {
    uint ret = bwapiPINVOKE.ErrorSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bwapiPINVOKE.ErrorSet_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    bwapiPINVOKE.ErrorSet_Clear(swigCPtr);
  }

  public Error getitem(Error key) {
    Error ret = new Error(bwapiPINVOKE.ErrorSet_getitem(swigCPtr, Error.getCPtr(key)), false);
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(Error key) {
    bool ret = bwapiPINVOKE.ErrorSet_ContainsKey(swigCPtr, Error.getCPtr(key));
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(Error key) {
    bwapiPINVOKE.ErrorSet_Add(swigCPtr, Error.getCPtr(key));
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(Error key) {
    bool ret = bwapiPINVOKE.ErrorSet_Remove(swigCPtr, Error.getCPtr(key));
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bwapiPINVOKE.ErrorSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Error get_next_key(IntPtr swigiterator) {
    Error ret = new Error(bwapiPINVOKE.ErrorSet_get_next_key(swigCPtr, swigiterator), false);
    if (bwapiPINVOKE.SWIGPendingException.Pending) throw bwapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
