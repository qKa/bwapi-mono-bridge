...
public partial class BaseLocationPtrSet : IDisposable 
#if !SWIG_DOTNET_1
 ...
 public System.Collections.Generic.ICollection<BaseLocation> Values {
  ...
  public BaseLocation getitem(BaseLocation key) {
    IntPtr cPtr = bwtaPINVOKE.BaseLocationPtrSet_getitem(swigCPtr, BaseLocation.getCPtr(key));
  ...
  public IntPtr create_iterator_begin() {
    IntPtr ret = bwtaPINVOKE.BaseLocationPtrSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public BaseLocation get_next_key(IntPtr swigiterator) {
    IntPtr cPtr = bwtaPINVOKE.BaseLocationPtrSet_get_next_key(swigCPtr, swigiterator);
    BaseLocation ret = (cPtr == IntPtr.Zero) ? null : new BaseLocation(cPtr, false);
    if (bwtaPINVOKE.SWIGPendingException.Pending) throw bwtaPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
