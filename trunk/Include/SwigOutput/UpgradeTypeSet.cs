...
public class UpgradeTypeSet : IDisposable 
 ...
 public System.Collections.Generic.ICollection<UpgradeType> Values {
  ...
  public UpgradeTypeSet() : this(bridgePINVOKE.new_UpgradeTypeSet__SWIG_0(), true) {
  }

  public UpgradeTypeSet(UpgradeTypeSet other) : this(bridgePINVOKE.new_UpgradeTypeSet__SWIG_1(UpgradeTypeSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.UpgradeTypeSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.UpgradeTypeSet_empty(swigCPtr);
    return ret;
  }
  ...
  public UpgradeType getitem(UpgradeType key) {
    UpgradeType ret = new UpgradeType(bridgePINVOKE.UpgradeTypeSet_getitem(swigCPtr, UpgradeType.getCPtr(key)), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(UpgradeType key) {
    bool ret = bridgePINVOKE.UpgradeTypeSet_ContainsKey(swigCPtr, UpgradeType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(UpgradeType key) {
    bridgePINVOKE.UpgradeTypeSet_Add(swigCPtr, UpgradeType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(UpgradeType key) {
    bool ret = bridgePINVOKE.UpgradeTypeSet_Remove(swigCPtr, UpgradeType.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.UpgradeTypeSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public UpgradeType get_next_key(IntPtr swigiterator) {
    UpgradeType ret = new UpgradeType(bridgePINVOKE.UpgradeTypeSet_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
