...
public class OrderSet : IDisposable 
 ...
 public System.Collections.Generic.ICollection<Order> Values {
  ...
  public OrderSet() : this(bridgePINVOKE.new_OrderSet__SWIG_0(), true) {
  }

  public OrderSet(OrderSet other) : this(bridgePINVOKE.new_OrderSet__SWIG_1(OrderSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.OrderSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.OrderSet_empty(swigCPtr);
    return ret;
  }
  ...
  public Order getitem(Order key) {
    Order ret = new Order(bridgePINVOKE.OrderSet_getitem(swigCPtr, Order.getCPtr(key)), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool ContainsKey(Order key) {
    bool ret = bridgePINVOKE.OrderSet_ContainsKey(swigCPtr, Order.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(Order key) {
    bridgePINVOKE.OrderSet_Add(swigCPtr, Order.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(Order key) {
    bool ret = bridgePINVOKE.OrderSet_Remove(swigCPtr, Order.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.OrderSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Order get_next_key(IntPtr swigiterator) {
    Order ret = new Order(bridgePINVOKE.OrderSet_get_next_key(swigCPtr, swigiterator), false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
