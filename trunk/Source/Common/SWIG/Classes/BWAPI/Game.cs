  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bwapiPINVOKE.delete_Game(swigCPtr);
        }
...
public static bool operator !=(Game obj1, Game obj2)
{
  ...
  public virtual Player self() {
    IntPtr cPtr = bwapiPINVOKE.Game_self(swigCPtr);
    Player ret = (cPtr == IntPtr.Zero) ? null : new Player(cPtr, false);
    return ret;
  }

  public virtual Player enemy() {
    IntPtr cPtr = bwapiPINVOKE.Game_enemy(swigCPtr);
    Player ret = (cPtr == IntPtr.Zero) ? null : new Player(cPtr, false);
    return ret;
  }
  ...
  public virtual SWIGTYPE_p_void getScreenBuffer() {
    IntPtr cPtr = bwapiPINVOKE.Game_getScreenBuffer(swigCPtr);
