...
public partial class GameImpl : Game {
  ...
  internal GameImpl(IntPtr cPtr, bool cMemoryOwn) : base(bwapiclientPINVOKE.GameImpl_SWIGUpcast(cPtr), cMemoryOwn) {
...
public static bool operator !=(GameImpl obj1, GameImpl obj2)
{
  ...
  public override bool hasPower(int x, int y, int tileWidth, int tileHeight) {
    bool ret = bwapiclientPINVOKE.GameImpl_hasPower__SWIG_0(swigCPtr, x, y, tileWidth, tileHeight);
    return ret;
  }

  public override bool hasPower(TilePosition position, int tileWidth, int tileHeight) {
    bool ret = bwapiclientPINVOKE.GameImpl_hasPower__SWIG_1(swigCPtr, TilePosition.getCPtr(position), tileWidth, tileHeight);
    if (bwapiclientPINVOKE.SWIGPendingException.Pending) throw bwapiclientPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public override Player self() {
    IntPtr cPtr = bwapiclientPINVOKE.GameImpl_self(swigCPtr);
    Player ret = (cPtr == IntPtr.Zero) ? null : new Player(cPtr, false);
    return ret;
  }

  public override Player enemy() {
    IntPtr cPtr = bwapiclientPINVOKE.GameImpl_enemy(swigCPtr);
    Player ret = (cPtr == IntPtr.Zero) ? null : new Player(cPtr, false);
    return ret;
  }
  ...
  public override SWIGTYPE_p_void getScreenBuffer() {
    IntPtr cPtr = bwapiclientPINVOKE.GameImpl_getScreenBuffer(swigCPtr);
