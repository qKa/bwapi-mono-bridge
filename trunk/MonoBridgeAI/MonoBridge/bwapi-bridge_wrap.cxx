...
SWIGINTERN void std_map_Sl_BWAPI_TilePosition_Sc_double_Sg__destroy_iterator(std::map< BWAPI::TilePosition,double > *self,std::map< BWAPI::TilePosition,double >::iterator *swigiterator){
        delete swigiterator;
      }
SWIGINTERN std::map< BWAPI::UnitType,int >::mapped_type const &std_map_Sl_BWAPI_UnitType_Sc_int_Sg__getitem(std::map< BWAPI::UnitType,int > *self,std::map< BWAPI::UnitType,int >::key_type const &key){
        std::map< BWAPI::UnitType,int >::iterator iter = self->find(key);
        if (iter != self->end())
          return iter->second;
        else
          throw std::out_of_range("key not found");
...
SWIGINTERN std::map< BWAPI::UnitType,int >::iterator *std_map_Sl_BWAPI_UnitType_Sc_int_Sg__create_iterator_begin(std::map< BWAPI::UnitType,int > *self){
        return new std::map< BWAPI::UnitType, int >::iterator(self->begin());
      }
SWIGINTERN std::map< BWAPI::UnitType,int >::key_type const &std_map_Sl_BWAPI_UnitType_Sc_int_Sg__get_next_key(std::map< BWAPI::UnitType,int > *self,std::map< BWAPI::UnitType,int >::iterator *swigiterator){
        std::map< BWAPI::UnitType, int >::iterator iter = *swigiterator;
        swigiterator++;
        return (*iter).first;
      }
SWIGINTERN void std_map_Sl_BWAPI_UnitType_Sc_int_Sg__destroy_iterator(std::map< BWAPI::UnitType,int > *self,std::map< BWAPI::UnitType,int >::iterator *swigiterator){
        delete swigiterator;
      }
...
SWIGINTERN std::vector< BWTA::Polygon >::const_reference std_vector_Sl_BWTA_Polygon_Sg__getitem(std::vector< BWTA::Polygon > *self,int index){
        if (index>=0 && index<(int)self->size())
          return (*self)[index];
        else
          throw std::out_of_range("index");
...
SWIGEXPORT void SWIGSTDCALL CSharp_Event_type_set(void * jarg1, int jarg2) {
  BWAPI::Event *arg1 = (BWAPI::Event *) 0 ;
...
SWIGEXPORT int SWIGSTDCALL CSharp_Event_type_get(void * jarg1) {
  int jresult ;
  BWAPI::Event *arg1 = (BWAPI::Event *) 0 ;
...
SWIGEXPORT void * SWIGSTDCALL CSharp_Event_position_get(void * jarg1) {
  ...
  arg1 = (BWAPI::Event *)jarg1; 
  result = (BWAPI::Position *)& ((arg1)->position);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_Orders_CTFCOP1_get() {
  void * jresult ;
  BWAPI::Order *result = 0 ;
...
SWIGEXPORT void * SWIGSTDCALL CSharp_new_UnitTypeIntMap__SWIG_1(void * jarg1) {
  void * jresult ;
  std::map< BWAPI::UnitType,int > *arg1 = 0 ;
  std::map< BWAPI::UnitType,int > *result = 0 ;
  
  arg1 = (std::map< BWAPI::UnitType,int > *)jarg1;
  if (!arg1) {
    SWIG_CSharpSetPendingExceptionArgument(SWIG_CSharpArgumentNullException, "std::map< BWAPI::UnitType,int > const & type is null", 0);
    return 0;
  } 
  result = (std::map< BWAPI::UnitType,int > *)new std::map< BWAPI::UnitType,int >((std::map< BWAPI::UnitType,int > const &)*arg1);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_UnitTypeIntMap_create_iterator_begin(void * jarg1) {
  void * jresult ;
  std::map< BWAPI::UnitType,int > *arg1 = (std::map< BWAPI::UnitType,int > *) 0 ;
  std::map< BWAPI::UnitType,int >::iterator *result = 0 ;
  
  arg1 = (std::map< BWAPI::UnitType,int > *)jarg1; 
  result = (std::map< BWAPI::UnitType,int >::iterator *)std_map_Sl_BWAPI_UnitType_Sc_int_Sg__create_iterator_begin(arg1);
  jresult = (void *)result; 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_UnitTypeIntMap_get_next_key(void * jarg1, void * jarg2) {
  void * jresult ;
  std::map< BWAPI::UnitType,int > *arg1 = (std::map< BWAPI::UnitType,int > *) 0 ;
  std::map< BWAPI::UnitType,int >::iterator *arg2 = (std::map< BWAPI::UnitType,int >::iterator *) 0 ;
  std::map< BWAPI::UnitType,int >::key_type *result = 0 ;
  
  arg1 = (std::map< BWAPI::UnitType,int > *)jarg1; 
  arg2 = (std::map< BWAPI::UnitType,int >::iterator *)jarg2; 
