...
public static bool operator !=(UnitCommand obj1, UnitCommand obj2)
{
  ...
  public UnitCommand(Unit source, UnitCommandType _type, Unit _target, int _x, int _y, int _extra) : this(bridgePINVOKE.new_UnitCommand__SWIG_1(Unit.getCPtr(source), UnitCommandType.getCPtr(_type), Unit.getCPtr(_target), _x, _y, _extra), true) {
  ...
  public static UnitCommand upgrade(Unit unit, UpgradeType upgrade) {
    UnitCommand ret = new UnitCommand(bridgePINVOKE.UnitCommand_upgrade(Unit.getCPtr(unit), UpgradeType.getCPtr(upgrade)), true);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public UnitCommandType type {
    set {
      bridgePINVOKE.UnitCommand_type_set(swigCPtr, UnitCommandType.getCPtr(value));
    } 
    get {
      IntPtr cPtr = bridgePINVOKE.UnitCommand_type_get(swigCPtr);
