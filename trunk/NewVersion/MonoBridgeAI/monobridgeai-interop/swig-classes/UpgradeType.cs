...
public static bool operator !=(UpgradeType obj1, UpgradeType obj2)
{
  ...
  public UnitType whatUpgrades() {
    UnitType ret = new UnitType(bridgePINVOKE.UpgradeType_whatUpgrades(swigCPtr), true);
    return ret;
  }

  public UnitTypeSet whatUses() {
    UnitTypeSet ret = new UnitTypeSet(bridgePINVOKE.UpgradeType_whatUses(swigCPtr), false);
    return ret;
  }
