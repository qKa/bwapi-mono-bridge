...
public static bool operator !=(BaseLocation obj1, BaseLocation obj2)
{
  ...
  public virtual UnitPtrSet getMinerals() {
    UnitPtrSet ret = new UnitPtrSet(bridgePINVOKE.BaseLocation_getMinerals(swigCPtr), false);
    return ret;
  }

  public virtual UnitPtrSet getStaticMinerals() {
    UnitPtrSet ret = new UnitPtrSet(bridgePINVOKE.BaseLocation_getStaticMinerals(swigCPtr), false);
    return ret;
  }

  public virtual UnitPtrSet getGeysers() {
    UnitPtrSet ret = new UnitPtrSet(bridgePINVOKE.BaseLocation_getGeysers(swigCPtr), false);
    return ret;
  }
