...
public static bool operator !=(UnitType obj1, UnitType obj2)
{
  ...
  public SWIGTYPE_p_std__pairT_BWAPI__UnitType_int_t whatBuilds() {
    SWIGTYPE_p_std__pairT_BWAPI__UnitType_int_t ret = new SWIGTYPE_p_std__pairT_BWAPI__UnitType_int_t(bridgePINVOKE.UnitType_whatBuilds(swigCPtr), true);
    return ret;
  }

  public SWIGTYPE_p_std__mapT_BWAPI__UnitType_int_t requiredUnits() {
    SWIGTYPE_p_std__mapT_BWAPI__UnitType_int_t ret = new SWIGTYPE_p_std__mapT_BWAPI__UnitType_int_t(bridgePINVOKE.UnitType_requiredUnits(swigCPtr), false);
    return ret;
  }

  public TechType requiredTech() {
    TechType ret = new TechType(bridgePINVOKE.UnitType_requiredTech(swigCPtr), true);
    return ret;
  }

  public TechTypeSet abilities() {
    TechTypeSet ret = new TechTypeSet(bridgePINVOKE.UnitType_abilities(swigCPtr), false);
    return ret;
  }

  public UpgradeTypeSet upgrades() {
    UpgradeTypeSet ret = new UpgradeTypeSet(bridgePINVOKE.UnitType_upgrades(swigCPtr), false);
    return ret;
  }

  public UpgradeType armorUpgrade() {
    UpgradeType ret = new UpgradeType(bridgePINVOKE.UnitType_armorUpgrade(swigCPtr), true);
    return ret;
  }
  ...
  public WeaponType groundWeapon() {
    WeaponType ret = new WeaponType(bridgePINVOKE.UnitType_groundWeapon(swigCPtr), true);
    return ret;
  }
  ...
  public WeaponType airWeapon() {
    WeaponType ret = new WeaponType(bridgePINVOKE.UnitType_airWeapon(swigCPtr), true);
    return ret;
  }
