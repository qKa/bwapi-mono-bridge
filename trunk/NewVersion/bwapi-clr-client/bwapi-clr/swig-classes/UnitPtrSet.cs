...
public partial class UnitPtrSet : IDisposable 
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          bridgePINVOKE.delete_UnitPtrSet(swigCPtr);
        }
 ...
 public System.Collections.Generic.ICollection<Unit> Values {
  ...
  public UnitPtrSet() : this(bridgePINVOKE.new_UnitPtrSet__SWIG_0(), true) {
  }

  public UnitPtrSet(UnitPtrSet other) : this(bridgePINVOKE.new_UnitPtrSet__SWIG_1(UnitPtrSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.UnitPtrSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.UnitPtrSet_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    bridgePINVOKE.UnitPtrSet_Clear(swigCPtr);
  }

  public Unit getitem(Unit key) {
    IntPtr cPtr = bridgePINVOKE.UnitPtrSet_getitem(swigCPtr, Unit.getCPtr(key));
  ...
  public bool ContainsKey(Unit key) {
    bool ret = bridgePINVOKE.UnitPtrSet_ContainsKey(swigCPtr, Unit.getCPtr(key));
    return ret;
  }

  public void Add(Unit key) {
    bridgePINVOKE.UnitPtrSet_Add(swigCPtr, Unit.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(Unit key) {
    bool ret = bridgePINVOKE.UnitPtrSet_Remove(swigCPtr, Unit.getCPtr(key));
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.UnitPtrSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Unit get_next_key(IntPtr swigiterator) {
    IntPtr cPtr = bridgePINVOKE.UnitPtrSet_get_next_key(swigCPtr, swigiterator);
    Unit ret = (cPtr == IntPtr.Zero) ? null : new Unit(cPtr, false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
