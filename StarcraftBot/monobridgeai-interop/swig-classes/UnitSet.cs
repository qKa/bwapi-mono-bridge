...
public partial class UnitSet : IDisposable 
 ...
 public System.Collections.Generic.ICollection<Unit> Values {
  ...
  public UnitSet() : this(bridgePINVOKE.new_UnitSet__SWIG_0(), true) {
  }

  public UnitSet(UnitSet other) : this(bridgePINVOKE.new_UnitSet__SWIG_1(UnitSet.getCPtr(other)), true) {
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = bridgePINVOKE.UnitSet_size(swigCPtr);
    return ret;
  }

  public bool empty() {
    bool ret = bridgePINVOKE.UnitSet_empty(swigCPtr);
    return ret;
  }
  ...
  public Unit getitem(Unit key) {
    IntPtr cPtr = bridgePINVOKE.UnitSet_getitem(swigCPtr, Unit.getCPtr(key));
  ...
  public bool ContainsKey(Unit key) {
    bool ret = bridgePINVOKE.UnitSet_ContainsKey(swigCPtr, Unit.getCPtr(key));
    return ret;
  }

  public void Add(Unit key) {
    bridgePINVOKE.UnitSet_Add(swigCPtr, Unit.getCPtr(key));
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(Unit key) {
    bool ret = bridgePINVOKE.UnitSet_Remove(swigCPtr, Unit.getCPtr(key));
    return ret;
  }

  public IntPtr create_iterator_begin() {
    IntPtr ret = bridgePINVOKE.UnitSet_create_iterator_begin(swigCPtr);
    return ret;
  }

  public Unit get_next_key(IntPtr swigiterator) {
    IntPtr cPtr = bridgePINVOKE.UnitSet_get_next_key(swigCPtr, swigiterator);
    Unit ret = (cPtr == IntPtr.Zero) ? null : new Unit(cPtr, false);
    if (bridgePINVOKE.SWIGPendingException.Pending) throw bridgePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
